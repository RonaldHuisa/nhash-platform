...
const PLAN_ROWS = [
  { level: "NiceHash-1", deposit: "5.00 - 100.00", income: "10.00%", validity: "120 días" },
  { level: "NiceHash-2", deposit: "100.00 - 300.00", income: "10.50%", validity: "120 días" },
  { level: "NiceHash-3", deposit: "300.00 - 800.00", income: "11.00%", validity: "120 días" },
  { level: "NiceHash-4", deposit: "800.00 - 1,500.00", income: "12.00%", validity: "120 días" },
  { level: "NiceHash-5", deposit: "1,500.00 - 4,000.00", income: "13.00%", validity: "120 días" },
  { level: "NiceHash-6", deposit: "4,000.00 - 8,000.00", income: "14.00%", validity: "120 días" },
  { level: "NiceHash-7", deposit: "8,000.00 - 15,000.00", income: "15.00%", validity: "120 días" },
  { level: "NiceHash-8", deposit: "15,000.00+", income: "16.00%", validity: "120 días" },
];
    ...
    <div className="page about-nicehash-page">
      ...
      <section className="about-nicehash-content">
        ...
        <div className="about-nicehash-income-card">
          ...
          <p>{t("Ingresos por minería de 10% a 16%, según el nivel NiceHash activo.")}</p>
        </div>
      </section>
